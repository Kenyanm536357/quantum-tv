...
function PlexLinkPanel() {
  ...
  return (
    <div className="neon-card p-5 sm:p-6" data-testid="plex-link-panel">
      <div className="flex items-center justify-between mb-4 gap-2">
        <h3 className="font-heading font-semibold text-base sm:text-lg">Plex Connection</h3>
        {status.data?.linked ? (
  ...
  return (
    <div data-testid="dashboard-page" className="space-y-6 sm:space-y-8 fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5">
        ...
        <div className="lg:col-span-2 neon-card p-5 sm:p-6">
