      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 p-1">
        {categories.map((cat, i) => (
          <button key={cat.category_id || i}
            ...
            style={{ minHeight: 56 }}
            className="group flex items-center gap-3.5 p-4 bg-card border border-border hover:border-primary/30 rounded-xl transition-all hover:bg-primary/5 text-left select-none">
